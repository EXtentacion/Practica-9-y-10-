        ...
        <div class="modal-body text-primary">
            ...
            <form method="POST" action="{{route('home.update',$item->id)}}">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="txttit" value="">
                </div>

                <div class="mb-3">
                <label class="form-label">Autor: </label>
                <input type="text" class="form-control" name="txtaut" value="">
                </div>

                <div class="mb-3"> 
                <label class="form-label">Paginas: </label>
                <input type="number" class="form-control" name="txtpag" value="">
                </div>

                <div class="mb-3"> 
                  <label class="form-label">Año de Publicacion: </label>
                  <input type="number" class="form-control" name="txtan" value="">
                  </div>
